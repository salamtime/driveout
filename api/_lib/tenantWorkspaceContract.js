export const LEGACY_BUSINESS_WORKSPACE_CONTRACT_VERSION = 'legacy_business_workspace_v1';

export const LEGACY_BUSINESS_WORKSPACE_REQUIRED_TABLES = Object.freeze([
  'app_organizations',
...
export const LEGACY_BUSINESS_WORKSPACE_REQUIRED_FUNCTIONS = Object.freeze([
  'app_current_organization_id',
  'get_user_effective_permissions',
]);

export const getLegacyBusinessWorkspaceContract = () => ({
  version: LEGACY_BUSINESS_WORKSPACE_CONTRACT_VERSION,
  requiredTables: LEGACY_BUSINESS_WORKSPACE_REQUIRED_TABLES,
  requiredFunctions: LEGACY_BUSINESS_WORKSPACE_REQUIRED_FUNCTIONS,
});
