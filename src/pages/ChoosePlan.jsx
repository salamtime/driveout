...
const ChoosePlan = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#eef2ff_0,#f8fafc_34%,#f8fafc_100%)] px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {PLAN_DEFINITIONS.map((plan) => {
            ...
            const darkHero = plan.id === 'growth' || plan.id === 'pro';
