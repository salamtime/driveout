CREATE TABLE IF NOT EXISTS public.saharax_0u4w4d_settings (
  ...
  rental_grace_period_minutes numeric(10,2) DEFAULT 60,
  rental_soft_lock_minutes numeric(10,2) DEFAULT 45,
  extra_hour_threshold_minutes numeric(10,2) DEFAULT 25,
  ...
  gemini_proxy_path text DEFAULT '/api/system-settings?action=gemini-proxy',
  ...
  messaging_photo_sharing_enabled boolean DEFAULT false,
  messaging_max_photos_per_message numeric(10,2) DEFAULT 3,
