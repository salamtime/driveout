      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-gray-900">Tier Pricing Applied</h4>
          </div>
          {isDiscounted && (
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-white border border-green-200 rounded-lg p-3">
            <div className="text-xs text-gray-600 mb-1">Your Tier Rate:</div>
            <div className="text-lg font-bold text-green-600">
              {tierRate.toFixed(2)} MAD/hour
            </div>
          </div>
          ...
          {isDiscounted && (
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-600 mb-1">Standard Rate:</div>
              <div className="text-lg font-bold text-gray-400 line-through">
                {standardHourlyRate.toFixed(2)} MAD/hour
              </div>
            </div>
          )}
        </div>
        ...
        {isDiscounted && savings > 0 && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-lg p-2 text-center">
            <div className="text-xs font-medium">Total Savings</div>
        ...
        {isSamePrice && (
          <div className="text-sm text-gray-600 text-center italic">
            Standard hourly rate applies for this duration
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="bg-gray-50 rounded p-2">
            <div className="text-gray-500 text-xs">Your Total</div>
          ...
          {isDiscounted && (
            <div className="bg-gray-50 rounded p-2">
              <div className="text-gray-500 text-xs">Standard Total</div>
